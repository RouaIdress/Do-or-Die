...
public class AttackerMovement extends Movement {
	...
	public void move(Grid grid , Unit unit) {
		if(grid.mainBase().getCenterY() > unit.getPosition().getCenterY()
				&&grid.mainBase().getCenterY()- unit.getPosition().getCenterY()> unit.getUnitProperties()[6].getPropertyValue()
		...
		else if(grid.mainBase().getCenterY()< unit.getPosition().getCenterY()
				&&unit.getPosition().getCenterY()-grid.mainBase().getCenterY()>unit.getUnitProperties()[6].getPropertyValue()
				&& unit.get_prev().getPosition().getCenterY() != unit.getPosition().getCenterY() - unit.getUnitProperties()[6].getPropertyValue()){
			...
			if(grid.mainBase().getCenterX()>unit.getPosition().getCenterX()
					&& grid.mainBase().getCenterX()-unit.getPosition().getCenterX() > unit.getUnitProperties()[6].getPropertyValue()
			...
			else if(grid.mainBase().getCenterX()<unit.getPosition().getCenterX()
					&&unit.getPosition().getCenterX()-grid.mainBase().getCenterX()>unit.getUnitProperties()[6].getPropertyValue()
					&&unit.get_prev().getPosition().getCenterX() != unit.getPosition().getCenterX()- (int)unit.getUnitProperties()[6].getPropertyValue()){
	...
	void MoveAroundVally(Grid grid,Unit unit) {
		...
		if (grid.mainBase().getCenterY()- grid.mainBase().getRadius() > unit.getPosition().getCenterY()+unit.getPosition().getRadius()) {
			if (IsThereAVallyUp(grid, unit)) {
				MoveRightOrLeft(grid, unit);
			}
		}
		else if (grid.mainBase().getCenterY()+grid.mainBase().getRadius() < unit.getPosition().getCenterY()-unit.getPosition().getRadius()) {
			if (IsThereAVallyDown(grid, unit)) {
				MoveRightOrLeft(grid,unit);
			}
		}
		else if (grid.mainBase().getCenterX()-grid.mainBase().getRadius() > unit.getPosition().getCenterX()+unit.getPosition().getRadius()){
